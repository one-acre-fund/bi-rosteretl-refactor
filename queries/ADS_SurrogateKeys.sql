...
from
    (
        select
            ...
            RosterDistrictID
        from
            OAF_SHARED_DIMENSIONS.dbo.DimLocations
        where
            RosterDistrictID is not null
    ) geo
where
    geo.RosterDistrictID = cls.staging_ADS.RosterDistrictID
...
where
    s.RosterSeasonID = cls.staging_ADS.RosterSeasonID
...
where
    client.ClientID = cls.staging_ADS.RosterClientID
    and client.DistrictID = cls.staging_ADS.RosterDistrictID
